package vn.example.itviec.config;
...
import vn.example.itviec.domain.Permission;
import vn.example.itviec.domain.Role;
import vn.example.itviec.domain.User;
import vn.example.itviec.repository.PermissionRepository;
import vn.example.itviec.repository.RoleRepository;
